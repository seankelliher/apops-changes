...
class JW_Post_Type
{
    ...
    function __construct($name, $post_type_args = array())
    {
        ...
        $this->post_type_name = $this->make_index( $name );
    ...
    private function make_index( $name ) {
        $name = explode( " ", strtolower( trim( $name ) ) );
...
session_write_close(); //Added by Sean on 2020/09/09.
